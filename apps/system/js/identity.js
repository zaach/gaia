...
const kIdentityScreen = 'https://b2g2fast2furious.personatest.org/sign_in#NATIVE';
//const kIdentityScreen = 'https://login.dev.anosrep.org/sign_in#NATIVE';
  ...
  handleEvent: function onMozChromeEvent(e) {
    ...
    switch (e.detail.type) {
      ...
      case 'open-id-dialog':
        ...
        TrustedUIManager.open('IdentityFlow', frame, kIdentityScreen, false);
        break;
